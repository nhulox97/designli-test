import { SnsResponseDoc } from 'src/ex1/doc/sns-response.doc';
import { SnsEventDto } from 'src/ex1/dto/sns-event.dto';

export const snsSesEventMock: SnsEventDto = {
  Records: [
    {
      eventVersion: '1.0',
      ses: {
...
export const parsedSnsEventMock: SnsResponseDoc = {
  spam: true,
  dns: true,
  month: 'September',
  virus: true,
